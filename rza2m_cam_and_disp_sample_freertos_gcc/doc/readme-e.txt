...
*******************************************************************************/
/*******************************************************************************
* System Name : [RZ/A2M] Camera and display sample application
* File Name   : readme-e.txt
*******************************************************************************/
/*******************************************************************************
*
* History     : Oct. 05,2018 Rev.1.00.00    First edition issued
*             : Dec. 28,2018 Rev.1.01.00    Delete description of Terminal App setting.
*             : Apr. 15,2019 Rev.1.02.00    Deleted "Directory Configuration"
*             : Dec. 17,2019 Rev.1.03.00    Modified "2.System Verification"
...
2. System Verification
  ...
  This sample code was developed and tested with the following components:
    ...
    Integrated development environment  : e2 studio Version 7.6.0.
...
3. About Sample Code
  ...
  (1) Application program [rza2m_cam_and_disp_sample_freertos_gcc]
    Output the MIPI camera input data to Display.
    Also, user can control the image quality adjustment function of VDC,
    such as Brightness, Contrast, and so on, via Terminal Application.
    ...
    The loader program is stored in the following folder.
      [rza2m_cam_and_disp_sample_freertos_gcc\bootloader\rza2_qspi_flash_ddr_bootloader.elf]
...
5. Operational Procedure
  ...
  (2) Setting up sample code
    Copy the directories of [rza2m_blinky_sample_osless_gcc] to the e2 studio workspace directory
    in the host PC (eg: "C:\e2studio_Workspace_v760").

  (3) Activating integrated development environment
    Activate the integrated development environment e2 studio.

  (4) Building application program ([rza2m_cam_and_disp_sample_freertos_gcc] project)
    After importing [rza2m_cam_and_disp_sample_freertos_gcc] project by the e2 studio menu, build the project 
    and generate the executable file named as rza2m_cam_and_disp_sample_freertos_gcc.elf.
  ...
  (6) Downloading sample code
    ...
    Select the debug configuration [rza2m_cam_and_disp_sample_freertos_gcc HardwareDebug] of the application program, 
  ...
  (8) Interacting with the sample code
    The terminal console can be accessed via the micro-USB connection CN5 on the Sub Board. Refer to "Camera and
    Display sample application note(R01AN4477)" for the details about this sample code.
